...
class Command {
    ...
    Show() {
        console.log(` ${"|-".repeat(this.deep)} ${(chalk_1.default.greenBright(this.name)).padEnd(60 - this.deep * 2)} ${!!this.actionDescription ? " | " : ""} ${chalk_1.default(this.actionDescription)}`);
    }
    Execute() {
