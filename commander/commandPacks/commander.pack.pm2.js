...
const pm2CommandsSection = {
    ...
    commands: {
        ...
        "-monit": Object.assign(Object.assign({}, pm2Commands.monit()), { printGap: true }),
        "-monitor": Object.assign(Object.assign({}, pm2Commands.monitor()), { printGap: true }),
        "-startup": pm2Commands.startup(),
        "-save": pm2Commands.save(),
        "-save-startup": Object.assign(Object.assign({}, pm2Commands.saveStartup()), { printGap: true }),
        "-start": pm2Commands.start(),
        "-restart": pm2Commands.restart(),
        "-stop": pm2Commands.stop(),
        "-delete": pm2Commands.delete(),
        "-reload": Object.assign(Object.assign({}, pm2Commands.reload()), { printGap: true }),
        "-ecosystem": pm2Commands.ecosystem()
    }
};
exports.default = pm2CommandsSection;
